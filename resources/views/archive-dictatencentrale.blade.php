	...
	<div class="container">
		<div class="row d-flex justify-content-center">
			<div class="col-12 col-md-9">
				...
				@if ($file = get_field('file', get_the_ID($item->ID)))
				<a href="{{ $file['url'] }}" title="Download {{ get_the_title($item->ID) }}">
					<div class="download-item d-flex align-items-center justify-content-between">
						<div class="content">
							<p class="heading">{{ get_the_title($item->ID) }}</p>
							<div class="meta">
								@if ($vak = get_the_terms(get_the_ID($item->ID), 'vak-dictatencentrale'))
								<div class="meta-item">
								...
								@endif
								@if ($type = get_the_terms(get_the_ID($item->ID), 'type-dictatencentrale'))
								<div class="meta-item">
